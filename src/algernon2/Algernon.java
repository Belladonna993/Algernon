...
import algernon2.MazeSpace;

public class Algernon {
	static final int ROWS = 20;
	static final int COLS = 40;
	private static MazeSpace[][] maze = new MazeSpace[ROWS][COLS];
	...
	void algernon() {
		...
		if (blocked) {
			System.out.println("You can't handle the cheese!");
		}
	...
	private void growTheBlob() {
		while (!startFound && !blocked) {
			MazeSpace[][] temp = new MazeSpace[ROWS][COLS];
	...
	void printMaze(MazeSpace[][] aMaze) {
		System.out.println();
